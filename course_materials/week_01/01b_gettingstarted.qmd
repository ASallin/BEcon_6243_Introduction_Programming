...
<!--
@Aurelien - I just tested it and the commands work in Windows Powershell - thus, no system-specifics are needed. Feel free to delete the comment.
-->
...
<!--
@Aurelien - might be good to remember students that this is all relative to the directory and happens in the directory the shell is in.
-->
...
- Go for `camelCase`, `snake_case` or `kebab-case`.
...
![](../../assets/img/casesOr-cases.jpg){width="640px"}
...
<!--
@Aurelien - doesn't display full content (at least in my browser). Last line is not visible. Might be good to add a scroll option or reduce the width?
-->

<div style="text-align: center;">
  <img src="../../assets/img/userId_cases.jpeg" width="440px" />
</div>
...
<!--
@Aurelien - maybe one thing to check that I remember led to issues for me is that no packages should be installed outside of venvs. Otherwise, this can lead to conflicts and venvs not properly initializing. Don't know if you came accross it but maybe it's good to know should students encounter problems when setting up their venvs.
-->
...
<!--
@Aurelien - Maybe add that pip freeze > requirements.txt is no longer needed in case some student uses that. (that's how understand it at least, I didn't work with uv before.)
-->
